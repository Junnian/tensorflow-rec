from feature_config import numerical_features, categorical_features, embedding_features, cross_features
...
feature2dtype["userRatedMovie1"] = "int32"
# 配置feature_columns
...
cross_column_list = [
	[
		{
		"column_name": feature,
		"feature_type": "categorical_column_with_identity",
		"num_buckets": embdding_dim[feature],
		"cross_buckets": 100000,
		"embedding_dim": 10
		}for feature in cross_feature
...
data_config = {
	...
	"cross_column_list":cross_column_list,
